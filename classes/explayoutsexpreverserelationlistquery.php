...
/**
 * eZ Publish 4 port of Netgen Layouts Exp ReverseRelationListQuery handler.
 */
class expLayoutsExpReverseRelationListQuery
{
    public static function getValues( $content, $fieldIdentifier = '', array $options = array() )
    {
        ...
        $reverseObjects = expLayoutsSiteAPI::loadReverseFieldRelations( $contentObject, $fieldIdentifier, $contentTypeFilter, null );

<section class="slb slb-features{if $block.values.css_class} {$block.values.css_class}{/if}" {if $block.values.css_id}id="{$block.values.css_id|wash}"{/if} data-block-id="{$block.id|wash}">

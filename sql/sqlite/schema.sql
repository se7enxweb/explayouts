...
CREATE INDEX IF NOT EXISTS idx_block_parameter_block ON explayouts_block_parameter(block_id);
...
CREATE INDEX IF NOT EXISTS idx_collection_item_collection_position ON explayouts_collection_item(collection_id, position);

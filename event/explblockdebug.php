...
class ExplBlockDebug
{
    public static function output( $output )
    {
        ...
        if ( $debug )
        {
            ...
            $html = '<div id="explDebugToolbar" class="expl-debug-toolbar" data-default-state="minimized">';
            ...
            $html .= '<button id="explDebugToggle" type="button" class="expl-debug-btn" title="Expand">+</button>';
...
(function() {
    ...
    function defaultState() {
        return (toolbar && toolbar.getAttribute('data-default-state')) || 'minimized';
    }
